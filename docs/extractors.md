...
**File:** `orihime/java_extractor.py`  
**Handles:** `.java`
...
**File:** `orihime/kotlin_extractor.py`  
**Handles:** `.kt`, `.kts`
...
`ExtractResult` is defined in `orihime/language.py` as a dataclass with four `list[dict]` fields.
...
### Java extractor (`orihime/java_extractor.py`)
...
### Kotlin extractor (`orihime/kotlin_extractor.py`)
