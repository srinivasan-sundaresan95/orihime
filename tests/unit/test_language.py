"""Unit tests for orihime.language — ExtractResult, registry, and parser helpers."""
...
def test_registered_extensions_includes_java_and_kotlin() -> None:
    """After importing orihime (with extractors), 'java' and 'kotlin' must appear in registered_extensions()."""
