...
from indra.java_extractor import JavaExtractor, _extract_impl_map
...
def _parse(fixture_name: str):
    ...
    from indra.java_extractor import _extract_package
...
def test_extract_result_impl_map_default_is_empty_dict():
    ...
    """
    from indra.language import ExtractResult
    r1 = ExtractResult()
    r2 = ExtractResult()
    assert r1.impl_map == {}
    assert r2.impl_map == {}
