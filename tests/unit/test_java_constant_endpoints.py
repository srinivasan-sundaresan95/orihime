...
from orihime.java_extractor import JavaExtractor, _extract_static_final_strings
...
def _build_constant_index() -> dict[str, str]:
    ...
    from orihime.java_extractor import _walk_all, _text, _find_first_child_of_type
